...
if __name__ == "__main__":
    ...
    ex3.prepare(config_file="topic_extraction/config/bertopic.yml", seed_topic_list=seed_topic_list)
    ...
    ex3.train(docs, normalize=True, embeddings=embeddings)
    ...
    ex3.plot_wonders(docs, add_doc_classes=[(1 if d.id in matching else 0) for d in docs])
